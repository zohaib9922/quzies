...
$comments_position = get_theme_mod($prefix . '_comments_position', 'above');
...
<div class="ct-comments" id="comments">
	...
	<?php if ( $comments_position === 'above' ) comment_form($form_options); ?>
	...
	<?php if ( $comments_position === 'below' ) comment_form($form_options); ?>
